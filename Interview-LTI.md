...
22. **To prevent DDOS attacks, which load balancer is used?**
...
37. **How do you differentiate within an AWS account dev env, test env, and prod env?**
...
51. **How do you push the image to DockerHub?**
